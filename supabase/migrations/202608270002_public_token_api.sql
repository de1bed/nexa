...
begin
  ...
  from public.qr_tokens q where q.token_hash=encode(sha256(convert_to(p_token,'UTF8')),'hex');
  ...
  where q.token_hash=encode(sha256(convert_to(p_token,'UTF8')),'hex') limit 1;
end $$;
